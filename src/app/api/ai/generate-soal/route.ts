...
const indicators = ["IK-01", "IK-02", "IK-03", "IK-04", "IK-05"] as const;
...
export async function POST(request: Request) {
  try {
    ...
    const result = await generateSoalAsesmen({ materi, indikator, jumlah: Number(jumlah), tingkat: tingkat as "mudah" | "sedang" | "sulit" });
    try {
